    ...
    return (
        <div id={props.id} className="menu menu-box-bottom menu-box-detached">
            <div className="menu-title">
                ...
                <h4 className="ps-3 font-700 text-uppercase mt-n2 font-12 opacity-30">{props.assetTicker}</h4>
            ...
            <div className="content">
                ...
                <div className="divider mb-4"></div>
                <a href="#" className="close-menu btn btn-full btn-m rounded-sm bg-highlight font-800 text-uppercase mb-4">Close
                    Description</a>
            </div>
        </div>
    )
